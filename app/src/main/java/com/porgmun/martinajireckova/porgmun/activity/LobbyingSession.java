...
public class LobbyingSession extends Fragment {

    private FragmentActivity myContext;
    private TextView odkaz_rules;
    private TextView odkaz_points;

    public LobbyingSession() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lobbying_session, container, false);
        ...
        odkaz_points.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager fragmentManager = myContext.getSupportFragmentManager();
                FragmentTransaction fragmentTransaction5 = fragmentManager.beginTransaction();
                fragmentTransaction5.replace(R.id.container_body, new PartsDebate());
                fragmentTransaction5.commit();
